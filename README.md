...
- The MSRP variable had almost no data making it hard to connect any
  variables to price
- Tesla often threw averages off having a much higher range than any
  other brand
- Having many models and cities in the data set, we often had to
  restructure our graphs to make it readable
- Only showing top models isn’t necessarily representative of all the
  models present
- The dataset we chose is only for registered cars in Washington so it
  isn’t a good representation of all cars in the US

## Conclusion

Overall, electric range varies significantly by make, model, vehicle
type, and location. We found that
